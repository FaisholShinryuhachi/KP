...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">Enol Management Stock Item</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="register.html">Item</a>
            <a class="dropdown-item" href="forgot-password.html">Category</a>
            <a class="dropdown-item" href="forgot-password.html">Satuan</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-fw fa-folder"></i>
            <span>Screen Service</span>
          </a>
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="login.html">Masuk</a>
            <a class="dropdown-item" href="register.html">Keluar</a>
            <a class="dropdown-item" href="forgot-password.html">Data Screen</a>
          </div>
        </li> 
         <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="register.html">New Item</a>
            <a class="dropdown-item" href="forgot-password.html">New Category</a>
            <a class="dropdown-item" href="forgot-password.html">New Satuan</a>
          </div>
        </li>               
